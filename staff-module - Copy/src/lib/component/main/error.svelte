<div class="flex flex-col items-center w-full">
    ...
    <div class="w-1/3 my-10">
        ...
        <div class="grid my-8">
            <div class="font-bold text-neutral-900 text-2xl leading-8">
                Profile
            </div>

            <div class="text-neutral-900 font-normal text-lg leading-7 mt-2">
        ...
        <form class="">
            <div class="grid grid-cols-2 gap-4">
                <div class="relative w-full">
                    <label
                        for="firstname"
                        class="font-semibold text-lg leading-6 text-neutral-900"
                    >
                        First name
                    </label>
                    <input
                        ...
                        class="w-full p-2 pr-10 border my-2 border-red-400 rounded-lg bg-slate-50 font-normal text-lg leading-7 text-slate-600 focus:outline-none"
                    />

                    <div
                        class="absolute inset-y-14 right-0 flex items-center pr-3 pointer-events-none"
                    >
                        <img
                            src="/icons/error.svg"
                            alt="Error Icon"
