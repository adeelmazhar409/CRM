...
type LayoutRouteId = RouteId | "/(app)/staff-member"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(app)/staff-member/+layout.server.js').load>>>>>>;
