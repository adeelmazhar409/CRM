<div class="flex flex-col items-center w-full">
            ...
            <div class="flex flex-col sm:hidden w-full py-1 border-b-2">
                <div
                    class="font-sans grid grid-cols-4 md:grid-cols-3 items-center"
                >
                    <button
                        type="button"
            ...
            <div class="px-4 my-2 w-full sm:w-1/2 lg:w-2/5">
                ...
                <div class="grid py-4 gap-2">
                    ...
                    >
                        You can only update the owner's nickname, email address,
                        and mobile number.
                    </div>
                </div>

                <div
                    class="flex flex-col md:grid md:grid-cols-2 gap-2 sm:gap-4"
                >
